 ...
 * Description : PurchaseItemDetialBean
 */

public class PurchaseItemDetialBean extends Id {

        /**
         * createDate : 2019-05-24T01:16:40.878Z
         * createMan : string
         * deleted : 0
         * expireDate : 2019-05-24T01:16:40.878Z
         * expireMinute : 0
         * fromAddress : string
         * fromMobile : string
         * fromName : string
         * fromShopId : 0
         * id : 0
         * modifyDate : 2019-05-24T01:16:40.878Z
         * modifyMan : string
         * payAmount : 0
         * paymentSn : string
         * paymentType : string
        ...
        private List<PurchaseDetailBean.PurchItemListBean> purchItemList;
        ...
        public List<PurchaseDetailBean.PurchItemListBean> getPurchItemList() {
            return purchItemList;
        }

        public void setPurchItemList(List<PurchaseDetailBean.PurchItemListBean> purchItemList) {
