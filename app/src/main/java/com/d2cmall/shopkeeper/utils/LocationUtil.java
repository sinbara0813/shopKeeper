...
public class LocationUtil implements AMapLocationListener {
    ...
    private static LocationUtil mLoctionUtil;
    ...
    public static LocationUtil getLoctionUtil(Context context) {
        if (mLoctionUtil == null) {
            mLoctionUtil = new LocationUtil(context.getApplicationContext());
        }
        return mLoctionUtil;
    }
