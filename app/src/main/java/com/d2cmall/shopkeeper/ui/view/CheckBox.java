...
public class CheckBox extends LinearLayout {
    ...
    private void initView() {
        selectedId = R.mipmap.icon_qingdan_dagou;//ic_personal_turn_out_season_normal;; ic_login_checked
        unselectedId = R.mipmap.icon_qingdan_bugou;//ic_personal_turn_out_season_actives;; ic_login_uncheck
