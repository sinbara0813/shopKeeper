package com.d2cmall.shopkeeper.ui.view.badge;
...
public class BadgeFactory {
    ...
    public static BadgeView createCircle(Context context){
        return  new BadgeView(context).setWidthAndHeight(13,13).setTextSize(10).setBadgeGravity(Gravity.RIGHT| Gravity.TOP).setShape(BadgeView.SHAPE_CIRCLE);
    }

    public static BadgeView createCircle1(Context context){
        return  new BadgeView(context).setWidthAndHeight(21,21).setTextSize(12).setBadgeGravity(Gravity.RIGHT| Gravity.TOP).setShape(BadgeView.SHAPE_CIRCLE);
    }
    ...
    public static BadgeView createOval(Context context){
        return  new BadgeView(context).setWidthAndHeight(16,13).setTextSize(10).setBadgeGravity(Gravity.RIGHT| Gravity.TOP).setShape(BadgeView.SHAPE_OVAL);
    }

    public static BadgeView createOval1(Context context){
        return  new BadgeView(context).setWidthAndHeight(24,21).setTextSize(12).setBadgeGravity(Gravity.RIGHT| Gravity.TOP).setShape(BadgeView.SHAPE_OVAL);
    }
