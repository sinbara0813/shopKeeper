...
import com.d2cmall.shopkeeper.adapter.AllotWarehouseSplitAdapterAdapter;
...
public class AllotWarehousingSplitFragment extends BaseFragment implements BaseView, ExpandListener, AllotWarehouseSplitAdapterAdapter.RefreshListener {
    ...
    private AllotWarehouseSplitAdapterAdapter orderListAdapter;
    ...
    public static AllotWarehousingSplitFragment newInstance(String status, int orderType) {//orderType区分拼团和普通
        AllotWarehousingSplitFragment orderListFragment = new AllotWarehousingSplitFragment();
    ...
    public static AllotWarehousingSplitFragment newInstance(long memberId) {
        AllotWarehousingSplitFragment orderListFragment = new AllotWarehousingSplitFragment();
        Bundle args = new Bundle();
        orderListFragment.setArguments(args);
        return orderListFragment;
    ...
    public void prepareView() {
        ...
        orderListAdapter = new AllotWarehouseSplitAdapterAdapter(getActivity(), getManager(), mOrderList);
    ...
    private void loadOrderList() {
        ...
        addDisposable(ApiRetrofit.getInstance().getApiService().getAllotItemList(map), new BaseObserver<BaseModel<AllotItemListBean>>(this) {
            @Override
            public void onSuccess(BaseModel<AllotItemListBean> orderList) {
               resetView();
                if (p == 1) {
                    mOrderList.clear();
                }
