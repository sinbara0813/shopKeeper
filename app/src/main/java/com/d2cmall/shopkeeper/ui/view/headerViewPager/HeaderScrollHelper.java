package com.d2cmall.shopkeeper.ui.view.headerViewPager;
    ...
    private boolean isRecyclerViewTop(RecyclerView recyclerView) {
        if (recyclerView != null) {
            ...
            if (layoutManager instanceof LinearLayoutManager) {
                ...
                int top=0;
                if (((DelegateAdapter)recyclerView.getAdapter()).getLayoutHelpers().get(0) instanceof StaggeredGridLayoutHelper){
                   top= ((StaggeredGridLayoutHelper)(((DelegateAdapter)recyclerView.getAdapter()).getLayoutHelpers().get(0))).getPaddingTop();
                }
                if (childAt == null || (firstVisibleItemPosition == 0 && childAt.getTop() ==top)) {
                    return true;
                }
            }
        }
