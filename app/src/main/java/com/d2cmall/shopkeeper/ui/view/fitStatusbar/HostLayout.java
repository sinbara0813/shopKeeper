 ...
 */
package com.d2cmall.shopkeeper.ui.view.fitStatusbar;
 ...
 * 侵入式状态栏 : 地址 https://github.com/yanzhenjie/Sofia
 */
class HostLayout extends RelativeLayout implements Bar {
    ...
    HostLayout(Activity activity) {
        ...
        SofiaUtils.invasionNavigationBar(mActivity);
        SofiaUtils.setStatusBarColor(mActivity, Color.TRANSPARENT);
        SofiaUtils.setNavigationBarColor(mActivity, Color.TRANSPARENT);
    }
