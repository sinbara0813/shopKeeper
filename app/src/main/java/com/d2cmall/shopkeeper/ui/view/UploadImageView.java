...
public class UploadImageView extends AppCompatImageView {
    ...
    public void upload() {
        if(pic.isVideo()){
            ...
            paramsMap.put(Params.SAVE_KEY, StringUtil.getUPYunSavePath(userId, Constants.TYPE_FRIEND));
    ...
    private void uploadVideo(){
        ...
        final Map<String, Object> paramsMap = new HashMap<>();
        paramsMap.put(Params.BUCKET, Constants.UPYUN_SPACE);
        paramsMap.put(Params.SAVE_KEY, StringUtil.getUPYunSavePath(userId, Constants.TYPE_VIDEO) + suffix);
        ...
        UploadEngine.getInstance().formUpload(file, paramsMap, "fune", UpYunUtils.md5("fune123"), completeListener, progressListener);
    }
