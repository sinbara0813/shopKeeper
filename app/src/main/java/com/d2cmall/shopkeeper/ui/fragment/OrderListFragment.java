...
public class OrderListFragment extends BaseFragment implements BaseView, ExpandListener {
    ...
    public static OrderListFragment newInstance(String status, int orderType) {//orderType区分拼团和普通
    ...
    public static OrderListFragment newInstance(long memberId) {
        OrderListFragment orderListFragment = new OrderListFragment();
        Bundle args = new Bundle();
    ...
    public void prepareView() {
        ...
        orderListAdapter = new OrderListAdapter(getActivity(), getManager(),1, mOrderList);
        if(memberId>0){
