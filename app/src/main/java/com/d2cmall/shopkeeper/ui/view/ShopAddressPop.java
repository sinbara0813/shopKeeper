 ...
 */
public class ShopAddressPop implements TransparentPop.InvokeListener {
    ...
    public ShopAddressPop(Context context) {
        rooView = LayoutInflater.from(context).inflate(R.layout.layout_shop_address_pop, new CoordinatorLayout(context), false);
