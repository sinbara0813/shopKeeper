...
import com.d2cmall.shopkeeper.adapter.PurchaseWarehouseWholeAdapterAdapter;
...
public class PurchaseWarehousingWholeFragment extends BaseFragment implements BaseView, ExpandListener, PurchaseWarehouseWholeAdapterAdapter.RefreshListener {
    ...
    private PurchaseWarehouseWholeAdapterAdapter orderListAdapter;
    ...
    public static PurchaseWarehousingWholeFragment newInstance(String status, int orderType) {//orderType区分拼团和普通
        PurchaseWarehousingWholeFragment orderListFragment = new PurchaseWarehousingWholeFragment();
    ...
    public static PurchaseWarehousingWholeFragment newInstance(long memberId) {
        PurchaseWarehousingWholeFragment orderListFragment = new PurchaseWarehousingWholeFragment();
        Bundle args = new Bundle();
        orderListFragment.setArguments(args);
        return orderListFragment;
    ...
    public void prepareView() {
        ...
        orderListAdapter = new PurchaseWarehouseWholeAdapterAdapter(getActivity(), getManager(), mOrderList);
    ...
    private void loadOrderList() {
        ...
        addDisposable(ApiRetrofit.getInstance().getApiService().getPurchList(map), new BaseObserver<BaseModel<PurchaseListBean>>(this) {
            @Override
            public void onSuccess(BaseModel<PurchaseListBean> orderList) {
               resetView();
                if (p == 1) {
                    mOrderList.clear();
                }
