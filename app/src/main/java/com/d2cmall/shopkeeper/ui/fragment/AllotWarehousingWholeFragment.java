...
import com.d2cmall.shopkeeper.adapter.AllotWarehouseWholeAdapterAdapter;
...
public class AllotWarehousingWholeFragment extends BaseFragment implements BaseView, ExpandListener, AllotWarehouseWholeAdapterAdapter.RefreshListener {
    ...
    private AllotWarehouseWholeAdapterAdapter orderListAdapter;
    ...
    public static AllotWarehousingWholeFragment newInstance(String status, int orderType) {//orderType区分拼团和普通
        AllotWarehousingWholeFragment orderListFragment = new AllotWarehousingWholeFragment();
    ...
    public static AllotWarehousingWholeFragment newInstance(long memberId) {
        AllotWarehousingWholeFragment orderListFragment = new AllotWarehousingWholeFragment();
        Bundle args = new Bundle();
        orderListFragment.setArguments(args);
        return orderListFragment;
    ...
    public void prepareView() {
        ...
        orderListAdapter = new AllotWarehouseWholeAdapterAdapter(getActivity(), getManager(), mOrderList);
    ...
    private void loadOrderList() {
        ...
        addDisposable(ApiRetrofit.getInstance().getApiService().getAllotList(map), new BaseObserver<BaseModel<AllotListBean>>(this) {
            @Override
            public void onSuccess(BaseModel<AllotListBean> orderList) {
               resetView();
                if (p == 1) {
                    mOrderList.clear();
                }
