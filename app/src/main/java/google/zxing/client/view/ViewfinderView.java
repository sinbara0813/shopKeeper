...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        mRect = new Rect();
        lineDrawable = getResources().getDrawable(R.mipmap.pic_scanqrcode);
        backGroundDrawable = getResources().getDrawable(R.mipmap.pic_whiteborders);
    }
...
//            canvas.drawRect(frame.right + 5, frame.bottom - 70, frame.right + 10, frame.bottom + 10, paint);
            backGroundDrawable.setBounds(frame.left, frame.top , frame.right, frame.bottom );
